...
! tangent-linear (TL) and finite differnece (FWD), 2024
! 
! The  TLFWD consistency of surface emissivity, where it is not a
...
PROGRAM test_TL
  ...
  Perturbation = Sfc(1)%Wind_Speed*0.01_fp

  WRITE(*,*) ' '
  WRITE(*,*) 'Surface Wind-speed Difference (TL): ', '0.01*Wind_Speed = ', Perturbation
  ...
  ! ============================================================================
   ...
   Sfc(2)%Wind_Speed = Sfc(2)%Wind_Speed + Perturbation
   Sfc(1)%Wind_Speed = Sfc(1)%Wind_Speed + Perturbation
  ! ============================================================================
  ...
  WRITE(*,*) ' '
  WRITE(*,*) '==================================='
  WRITE(*,*) 'Radiance TL-FWD  Comparision'
  WRITE(*,*) '==================================='
  stl = RTSolution_TL(5,1)%Radiance
  sfwd = RTSolution_Perturb(5,1)%Radiance - RTSolution(5,1)%Radiance
  WRITE(*,*) 'Tangent-linear: ', stl
  WRITE(*,*) 'Finit-Difference: ', sfwd
  Ratio = sfwd / stl
  WRITE(*,*) 'TL-FWD Ratio: ', Ratio
  IF(ABS(ONE - Ratio) < TOLERANCE) THEN
    WRITE(*,*) 'TL-FWD testing passed! '
  ELSE
    WRITE(*,*) 'TL-FWD testing failed ....'
  END IF
 
  WRITE(*,*) ' '
  WRITE(*,*) '==================================='
  WRITE(*,*) 'Emissivity TL-FWD  Comparision'
  WRITE(*,*) '==================================='
  stl = RTSolution_TL(5,1)%Surface_Emissivity
  sfwd = RTSolution_Perturb(5,1)%Surface_Emissivity- RTSolution(5,1)%Surface_Emissivity
  WRITE(*,*) 'Tangent-linear: ', stl
  WRITE(*,*)'Finit-Difference',sfwd
  Ratio = sfwd / stl
  WRITE(*,*) 'TL-FWD Ratio: ', Ratio
